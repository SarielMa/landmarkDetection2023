...
class CephaDataset2023(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Extentsion with landmarks
        # edge_index is a fully-connected graph with 38 points, all image remains the same one, NOT REQUIRED
